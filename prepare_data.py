"""Create data/ctr_data.csv from the CRL-Dataset-CTCR-Pose csv.

    python prepare_data.py --raw data/CRL-Dataset-CTCR-Pose.csv
"""
import argparse
...
if __name__ == "__main__":
    ...
    p.add_argument("--out", default="data/ctr_data.csv")
